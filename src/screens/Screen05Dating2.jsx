...
export default function Screen05Dating2({ onNext }) {
  return <div className="screen">
    ...
    <div className="card screen-body"><p>Нормальный вариант, приличный, местами даже симпатичный.</p><p><strong>Но есть проблема:</strong></p><ul><li>без секретного маршрута;</li><li>без интриги;</li><li>без ощущения «вау, это всё для меня»;</li><li>без маленького человека с пионами.</li></ul></div>
